...
function buildShishigaya() {
  ...
  const NAMED = [
    ...
    [3300, -45, 'conbini', 'ファミリーマート', 16], [3316, -62, 'tobacco', 'たばこ・酒', 13], [2722, 66, 'green', '八百屋', 13], [2708, 50, 'flower', '花屋', 13], [2681, -111, 'super', 'マミート', 24], // マミートはユーザー指定の飛行ピン game(2681,111)へ（NAMEDはz反転前なので-111）。2026-06-24
