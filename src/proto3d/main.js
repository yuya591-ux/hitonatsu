...
const bonOdori = new THREE.Group(); bonOdori.visible = false; scene.add(bonOdori) // 盆踊り会場（櫓＋提灯）＝小学校の校庭。開催日だけ姿を見せる
{
  ...
  // ── 【谷の東の森／ユーザー要望・赤い範囲】谷の道の“東側”～北の新しい土地にかけて広い一帯を森に（道はこの森の西を通る）──
  for (const [tx, tz, ts] of [
    [937, 116, 1.3], [949, 113, 1.1], [961, 118, 1.4], [973, 114, 1.2], [985, 119, 1.3], [996, 115, 1.1],
    [935, 138, 1.2], [948, 135, 1.4], [960, 140, 1.1], [973, 136, 1.3], [985, 134, 1.2], [997, 139, 1.4],
    [936, 160, 1.4], [949, 157, 1.2], [961, 162, 1.3], [972, 158, 1.1], [984, 163, 1.4], [996, 159, 1.2],
    [935, 182, 1.1], [948, 180, 1.3], [961, 184, 1.2], [973, 179, 1.4], [985, 183, 1.1], [997, 181, 1.3],
    [937, 204, 1.3], [949, 201, 1.1], [960, 206, 1.4], [972, 202, 1.2], [984, 205, 1.3], [996, 203, 1.1],
    [936, 222, 1.2], [948, 220, 1.4], [960, 224, 1.1], [972, 221, 1.3], [984, 223, 1.2], [995, 219, 1.4],
  ]) makeTree(tx, tz, ts)
  // ── ブランコ（乗ってブランコ視点であそぶ）──
  {
