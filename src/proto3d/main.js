...
const townNightLights = [] // 夜に灯る街のあかり（窓・街灯・自販機）。nfで点灯＝夜のエモさ
{
  ...
  makeRoadRibbon(T.x + 8, T.z + 22, T.x + 8, T.z + 60, 7, true, true)    // ふもと(交差路)→中腹
  makeRoadRibbon(T.x + 8, T.z + 60, T.x + 8, T.z + 92, 7, true, true)    // 中腹→頂上(裏山の頂・見晴らしの脇)
  makeRoadRibbon(T.x + 8, T.z + 92, T.x + 11, T.z + 148, 7, true, true)  // 頂上を越えて反対側を長く下り、山あいの奥へずっと続く
  makeGuardrail(T.x + 12.5, T.z + 30, T.x + 14, T.z + 140)               // 谷側(東)のガードレール（峰の先まで沿わせる）
  // 裏山の雑木（斜面に点々と＝木立の山）
