...
const bonOdori = new THREE.Group(); bonOdori.visible = false; scene.add(bonOdori) // 盆踊り会場（櫓＋提灯）＝小学校の校庭。開催日だけ姿を見せる
{
  ...
  for (const [tx, tz, ts] of [
    ...
    [911, 101, 1.3], [901, 99, 1.1], [890, 103, 1.4], [879, 100, 1.2], [869, 104, 1.3],
    [910, 112, 1.1], [900, 110, 1.3], [889, 114, 1.2], [878, 111, 1.4], [868, 115, 1.1],
    [908, 123, 1.3], [898, 121, 1.2], [887, 125, 1.1], [876, 122, 1.3], [868, 126, 1.2],
