...
function buildShishigaya() {
  ...
  const NAMED = [
    ...
    [3300, -45, 'conbini', 'ファミリーマート', 16], [3347, -65, 'tobacco', 'たばこ・酒', 13], [2737, 119, 'green', '八百屋', 13], [2737, 131, 'flower', '花屋', 13], [2681, -111, 'super', 'マミート', 24], // ユーザー飛行ピンで位置修正(game)：八百屋2737,-119/花屋2737,-131/たばこ屋3347,65/マミート2681,111。NAMEDはz反転前。ファミマは要再指定(花屋と同座標で来たため据置)。2026-06-24
