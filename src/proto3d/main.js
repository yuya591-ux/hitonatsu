...
const bonOdori = new THREE.Group(); bonOdori.visible = false; scene.add(bonOdori) // 盆踊り会場（櫓＋提灯）＝小学校の校庭。開催日だけ姿を見せる
{
  ...
  for (const [tx, tz, ts] of [[897, 64, 1.4], [906, 71, 1.2], [894, 55, 1.5], [909, 60, 1.1], [900, 47, 1.3], [895, 31, 1.3], [899, 16, 1.2], [894, 41, 1.4], [897, 1, 1.2], [901, -16, 1.1], [886, -52, 1.2], [893, -66, 1.1]]) makeTree(tx, tz, ts) // ※マンション南脇の2本は西移設に合わせ10m西へ((896,-52)→(886,-52)/(903,-66)→(893,-66))
  ...
  // 二つ池をぐるりと囲む周回路（半径≒15・公園の外周。8区間で環にする。舗装で連続させる）
