...
function buildShishigaya() {
  ...
  const NAMED = [
    ...
    [3300, -45, 'conbini', 'ファミリーマート', 16], [3316, -62, 'tobacco', 'たばこ・酒', 13], [2722, 66, 'green', '八百屋', 13], [2708, 50, 'flower', '花屋', 13], [2540, -30, 'super', 'マミート', 24], // マミートは平地(標高差1.4m)へ。旧[2588,-18]は急斜面だった
